...
The `R` work starts here `R emo::ji("grimmace")`, continued from work assembling the [metagenomic data](./shotgun_assembly.html).
...
## 1-2a. Import data to R, and re-arrange for `Kraken2+Bracken`.
...
## for Kraken2:
  ...
  ## tsv output
    write.file(mg_counts, "output/fhi__redch__krakenStnd-20__num..tsv")
    write.file(mg_relab, "output/fhi__redch__krakenStnd-20__frac..tsv")
...
## for Kaiju:
  ...
  ## tsv output
    write.file(mg_counts, "output/fhi__redch__kaijuStnd-20__num..tsv")
    write.file(mg_relab, "output/fhi__redch__kaijuStnd-20__frac..tsv")
    write.file(tax, "output/fhi__redch__kaijuStnd-20__tax..tsv")
    write.file(mgdat, "output/fhi__redch__kaijuStnd-20__dat..tsv")
    
  ## RDS for R output - note samples are ROWS
    saveRDS( t(j), "output/fhi__redch__kaijuStnd-20__num.RDS")
    saveRDS( t(k), "output/fhi__redch__kaijuStnd-20__frac.RDS")
    saveRDS( tax, "output/fhi__redch__kaijuStnd-20__tax.RDS")
    saveRDS( mgdat, "output/fhi__redch__kaijuStnd-20__dat.RDS")
...
## 4. bring that output into `R::phyloseq`
