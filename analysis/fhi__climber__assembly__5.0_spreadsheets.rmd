...
## Kraken2/Bracken   ---
  ...
  # look at the first ten rows, ten columns:
    ...
    (k2_phyloseq_dat <- phyloseq(k2_counts, k2_tax, mgdat))

    saveRDS( k2_phyloseq_dat, "./rmicro__KrakenStnd__phylo.RDS")
    k2_phylo <- readRDS("./rmicro__KrakenStnd__phylo.RDS")
    k2_phylo
...
## Kaiju   ----------
  ...
  # note: we use the count data..
    (kai_phyloseq_dat <- phyloseq(ka_counts, ka_tax, mgdat))

    saveRDS( kai_phyloseq_dat, "./rmicro__KaijuStnd__phylo.RDS")
    kai_phylo <- readRDS("./rmicro__KaijuStnd__phylo.RDS")
    kai_phylo
