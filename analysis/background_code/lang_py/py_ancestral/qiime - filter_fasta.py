#!/home/jfg/miniconda2/bin/python

#j#	jfg:
#j#   made a a script to filter out rep_set seqs from reference files, based on SMR otus
#j#   that took x1,000,000 times longer than QIIMe. Big difference likely lookup libraries
#j#   but worth learning why and how.
#j#
...
#j#	jfg:
#j#   note imported content: not a self contained operation. 
