...
Following from work assembling the [metagenomic data](./shotgun_assembly.html), and importing the microbial community into `R`-friendly format. There are no outputs to see here yet. 
